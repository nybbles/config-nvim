return {
  ...
  config = function(_, opts)
    ...
    -- Set up which-key integration for Octo buffers
    local function setup_octo_which_key()
      local wk_ok, wk = pcall(require, "which-key")
      if not wk_ok then return end
      
      -- Register which-key groups for Octo buffers
      wk.add({
        ...
        { "<localleader>p", group = "Pull Requests" },
        { "<localleader>r", group = "Reactions" },
        { "<localleader>v", group = "Reviews" },
        { "<localleader>s", group = "Suggestions" },
      }, { buffer = vim.api.nvim_get_current_buf() })
    end
    
    -- Auto-setup which-key for Octo buffers
    vim.api.nvim_create_autocmd({"BufEnter", "BufWinEnter"}, {
      pattern = {"octo://*", "*.octo"},
      callback = setup_octo_which_key,
    })
    
    -- Also setup for existing Octo buffers
